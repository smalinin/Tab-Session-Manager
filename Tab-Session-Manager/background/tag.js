...
async function addTag(id, tag) {
    ...
    const reservedTag = ['regular', 'winClose', 'temp', '_displayAll', '_user', '_auto', Browser.api.i18n.getMessage('regularSaveSessionName'), Browser.api.i18n.getMessage('winCloseSessionName')];
